          ...
          <div className={props.className}>
            ...
            <div className='absolute left-[31%] bottom-[8%]'>
              ...
              <div className='border-[1px] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] md:w-[350px] h-[50px] lg:w-[400px] rounded-t-[10px]'>
                ...
                <form onKeyDown={(e) => keyDownFunction(e)} className='relative' onSubmit={(e) => e.preventDefault()}>
                  <input 
                  onChange={(e) => {
                  ...
                  value={message} />
                  <button onClick={(e) => keyDownFunction(e)} className='bg-[#f8f9fa] border-[2px] border-[#d4d4d4] text-[14px] px-2 py-[3px] text-[#9e9e9e] font-medium rounded-[7px] absolute right-0 top-1/2 -translate-y-1/2'>
                    Send
                  </button>
                </form>
